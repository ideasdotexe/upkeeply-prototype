  ...
  return (
    <DashboardLayout>
      <div className="p-6 space-y-6">
          ...
          <CardContent className="p-6">
            <Calendar
              ...
              classNames={{
                ...
                nav_button: "h-9 w-9 bg-transparent p-0 opacity-50 hover:opacity-100 border rounded-md hover:bg-muted",
                ...
                day: "h-14 w-full p-0 font-normal aria-selected:opacity-100 hover:bg-muted rounded-md transition-colors",
        ...
        {selectedDate && selectedDateInspections.length > 0 && (
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-base flex items-center gap-2">
                <CalendarDays className="h-5 w-5 text-primary" />
                {format(selectedDate, "MMMM d, yyyy")} - {selectedDateInspections.length} inspection{selectedDateInspections.length > 1 ? "s" : ""}
              </CardTitle>
            </CardHeader>
            <CardContent>
